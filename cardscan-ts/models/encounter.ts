...
export type EncounterServiceTypeCodesEnum =
  (typeof EncounterServiceTypeCodesEnum)[keyof typeof EncounterServiceTypeCodesEnum];
export const EncounterReferenceIdentificationQualifierEnum = {
  _9F: "9F",
  G1: "G1",
} as const;

export type EncounterReferenceIdentificationQualifierEnum =
  (typeof EncounterReferenceIdentificationQualifierEnum)[keyof typeof EncounterReferenceIdentificationQualifierEnum];
...
export type EncounterIndustryCodeEnum =
  (typeof EncounterIndustryCodeEnum)[keyof typeof EncounterIndustryCodeEnum];
...
export type EncounterProductOrServiceIDQualifierEnum =
  (typeof EncounterProductOrServiceIDQualifierEnum)[keyof typeof EncounterProductOrServiceIDQualifierEnum];
