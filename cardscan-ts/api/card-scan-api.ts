...
export const CardScanApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} xAmzAlgorithm The algorithm used to sign the request
         * @param {string} xAmzCredential The credential used to sign the request
         * @param {string} xAmzDate The date of the request
         * @param {string} xAmzSecurityToken The security token used to sign the request
         * @param {string} policy The policy used to sign the request
         * @param {string} xAmzSignature The signature used to sign the request
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        directUpload: async (orientation: ScanOrientation, captureType: ScanCaptureType, cardId: string, file: File, key: string, xAmzAlgorithm: string, xAmzCredential: string, xAmzDate: string, xAmzSecurityToken: string, policy: string, xAmzSignature: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('directUpload', 'file', file)
            // verify required parameter 'key' is not null or undefined
            assertParamExists('directUpload', 'key', key)
            // verify required parameter 'xAmzAlgorithm' is not null or undefined
            assertParamExists('directUpload', 'xAmzAlgorithm', xAmzAlgorithm)
            // verify required parameter 'xAmzCredential' is not null or undefined
            assertParamExists('directUpload', 'xAmzCredential', xAmzCredential)
            // verify required parameter 'xAmzDate' is not null or undefined
            assertParamExists('directUpload', 'xAmzDate', xAmzDate)
            // verify required parameter 'xAmzSecurityToken' is not null or undefined
            assertParamExists('directUpload', 'xAmzSecurityToken', xAmzSecurityToken)
            // verify required parameter 'policy' is not null or undefined
            assertParamExists('directUpload', 'policy', policy)
            // verify required parameter 'xAmzSignature' is not null or undefined
            assertParamExists('directUpload', 'xAmzSignature', xAmzSignature)
            ...
            if (xAmzAlgorithm !== undefined) { 
                localVarFormParams.append('x-amz-algorithm', xAmzAlgorithm as any);
            }
    
            if (xAmzCredential !== undefined) { 
                localVarFormParams.append('x-amz-credential', xAmzCredential as any);
            }
    
            if (xAmzDate !== undefined) { 
                localVarFormParams.append('x-amz-date', xAmzDate as any);
            }
    
            if (xAmzSecurityToken !== undefined) { 
                localVarFormParams.append('x-amz-security-token', xAmzSecurityToken as any);
            }
            ...
            if (xAmzSignature !== undefined) { 
                localVarFormParams.append('x-amz-signature', xAmzSignature as any);
            }
         ...
         * @throws {RequiredError}
         */
        getScanMetadata: async (scanId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listEligibility: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/eligibility`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const CardScanApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async directUpload(orientation: ScanOrientation, captureType: ScanCaptureType, cardId: string, file: File, key: string, xAmzAlgorithm: string, xAmzCredential: string, xAmzDate: string, xAmzSecurityToken: string, policy: string, xAmzSignature: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DirectUpload200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.directUpload(orientation, captureType, cardId, file, key, xAmzAlgorithm, xAmzCredential, xAmzDate, xAmzSecurityToken, policy, xAmzSignature, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getScanMetadata(scanId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getScanMetadata(scanId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['CardScanApi.getScanMetadata']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async listEligibility(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListEligibility200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listEligibility(options);
            const index = configuration?.serverIndex ?? 0;
...
export const CardScanApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        directUpload(orientation: ScanOrientation, captureType: ScanCaptureType, cardId: string, file: File, key: string, xAmzAlgorithm: string, xAmzCredential: string, xAmzDate: string, xAmzSecurityToken: string, policy: string, xAmzSignature: string, options?: any): AxiosPromise<DirectUpload200Response> {
            return localVarFp.directUpload(orientation, captureType, cardId, file, key, xAmzAlgorithm, xAmzCredential, xAmzDate, xAmzSecurityToken, policy, xAmzSignature, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Card - Generate Upload URL
        ...
        getScanMetadata(scanId: string, options?: any): AxiosPromise<void> {
            return localVarFp.getScanMetadata(scanId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List Cards
        ...
        listEligibility(options?: any): AxiosPromise<ListEligibility200Response> {
            return localVarFp.listEligibility(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Search Cards (200) OK
...
export class CardScanApi extends BaseAPI {
  ...
  public async fullScan({
    ...
    return this.withWebsocket(async (websocket) => {
      ...
      const frontSideUploadUrlResponse = (
        await this.generateCardUploadUrl(createCardResponse.card_id, 3600, {
          orientation: ScanOrientation.Front,
        })
      ).data;

      const formData = this.cardFormDataFactory(
        frontImage,
        frontSideUploadUrlResponse.upload_parameters
      );

      try {
        await this.axios.post(frontSideUploadUrlResponse.upload_url, formData, {
          headers: {
      ...
      await new Promise((resolve, reject) => {
        websocket.onmessage = (event) => {
          ...
          if (data.state === CardState.FrontsideFailed) {
            return reject(new Error("Frontside failed"));
          }
        };
      });
      ...
      const event: CardWebsocketEvent = await new Promise((resolve, reject) => {
        websocket.onmessage = (event) => {
          const data: CardWebsocketEvent = JSON.parse(event.data as string);
          ...
          if (data.state === CardState.BacksideFailed) {
            return reject(new Error("Backside failed"));
          }
        };
      });
  ...
  private cardFormDataFactory(file: File, uploadParameters: UploadParameters) {
    const formData = new FormData();
    formData.append("file", file);
    formData.append("key", uploadParameters.key);
    formData.append("x-amz-algorithm", uploadParameters["x-amz-algorithm"]);
    formData.append("x-amz-credential", uploadParameters["x-amz-credential"]);
    formData.append("x-amz-date", uploadParameters["x-amz-date"]);
    formData.append(
      "x-amz-security-token",
      uploadParameters["x-amz-security-token"]
    );
    formData.append("policy", uploadParameters.policy);
    formData.append("x-amz-signature", uploadParameters["x-amz-signature"]);
  ...
  private XMLErrorToCardScanError(
    ...
    return {
      message: xmlErrorObj.Message._text,
      type: xmlErrorObj.Code._text,
      code,
    };
  }
  ...
  public async checkEligibility(cardId: string, eligibility: EligibilityInfo) {
        ...
        (resolve, reject) => {
          websocket.onmessage = (event) => {
            ...
            if (data.state === EligibilityState.Error) {
              return reject(new Error("Eligibility process failed"));
            }
          };
        }
      );
    ...
    public createCard(createCardRequest?: CreateCardRequest, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).createCard(createCardRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public createEligibility(createEligibilityRequest?: CreateEligibilityRequest, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).createEligibility(createEligibilityRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteCardById(cardId: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).deleteCardById(cardId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public directUpload(orientation: ScanOrientation, captureType: ScanCaptureType, cardId: string, file: File, key: string, xAmzAlgorithm: string, xAmzCredential: string, xAmzDate: string, xAmzSecurityToken: string, policy: string, xAmzSignature: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).directUpload(orientation, captureType, cardId, file, key, xAmzAlgorithm, xAmzCredential, xAmzDate, xAmzSecurityToken, policy, xAmzSignature, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public generateCardUploadUrl(cardId: string, expiration?: number, generateCardUploadUrlRequest?: GenerateCardUploadUrlRequest, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).generateCardUploadUrl(cardId, expiration, generateCardUploadUrlRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public generateMagicLink(options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).generateMagicLink(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public generateUploadUrl(expiration: number, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).generateUploadUrl(expiration, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAccessToken(userId?: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).getAccessToken(userId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getCardById(cardId: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).getCardById(cardId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public getEligibilityById(eligibilityId: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).getEligibilityById(eligibilityId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getScanMetadata(scanId: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).getScanMetadata(scanId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public listCards(limit?: number, cursor?: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).listCards(limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listEligibility(options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).listEligibility(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public searchCards(query: string, limit?: number, cursor?: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).searchCards(query, limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public validateMagicLink(token: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).validateMagicLink(token, options).then((request) => request(this.axios, this.basePath));
    }
}
