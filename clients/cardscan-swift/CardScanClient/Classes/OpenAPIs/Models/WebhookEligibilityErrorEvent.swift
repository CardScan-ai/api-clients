//
// WebhookEligibilityErrorEvent.swift
//
...
public struct WebhookEligibilityErrorEvent: Codable, JSONEncodable, Hashable {
    ...
    public var error: WebhookEligibilityErrorEventError
    ...
    public init(eligibilityId: UUID, cardId: UUID, createdAt: Date, deleted: Bool, error: WebhookEligibilityErrorEventError, sessionId: String, type: String, updatedAt: Date, userId: String) {
