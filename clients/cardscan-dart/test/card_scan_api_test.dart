...
void main() {
  ...
  group(CardScanApi, () {
    ...
    //
    //Future<CardPerformance200Response> cardPerformance(String cardId, { JsonObject body }) async
    test('test cardPerformance', () async {
      // TODO
    });
    ...
    // Set Scan Metadata
    //
    //Future setScanMetadata(String scanId, { JsonObject body }) async
    test('test setScanMetadata', () async {
      // TODO
    });
