...
class EligibilityApiResponseEligibilityRequest {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  EligibilityApiResponseEligibilityRequestProvider? provider;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.controlNumber != null) {
      json[r'control_number'] = this.controlNumber;
    } else {
      json[r'control_number'] = null;
    }
    if (this.tradingPartnerServiceId != null) {
      json[r'trading_partner_service_id'] = this.tradingPartnerServiceId;
    } else {
      json[r'trading_partner_service_id'] = null;
    }
  ...
  static EligibilityApiResponseEligibilityRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EligibilityApiResponseEligibilityRequest(
        controlNumber: mapValueOfType<String>(json, r'control_number'),
        tradingPartnerServiceId: mapValueOfType<String>(json, r'trading_partner_service_id'),
        provider: EligibilityApiResponseEligibilityRequestProvider.fromJson(json[r'provider']),
