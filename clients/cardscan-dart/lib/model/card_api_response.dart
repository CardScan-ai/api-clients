...
class CardApiResponse {
  ...
  int get hashCode =>
    ...
    (payerMatch == null ? 0 : payerMatch!.hashCode) +
  ...
  @override
  String toString() => 'CardApiResponse[cardId=$cardId, state=$state, createdAt=$createdAt, error=$error, payerMatch=$payerMatch, metadata=$metadata, images=$images, deleted=$deleted, details=$details]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.payerMatch != null) {
      json[r'payer_match'] = this.payerMatch;
    } else {
      json[r'payer_match'] = null;
    }
  ...
  static CardApiResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CardApiResponse(
        ...
        payerMatch: PayerMatch.fromJson(json[r'payer_match']),
        metadata: CardResponseMetadata.fromJson(json[r'metadata']),
