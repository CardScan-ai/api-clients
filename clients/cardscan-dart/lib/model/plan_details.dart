...
class PlanDetails {
  ...
  @override
  String toString() => 'PlanDetails[planNumber=$planNumber, groupName=$groupName, groupNumber=$groupNumber, planStartDate=$planStartDate, planEligibilityStartDate=$planEligibilityStartDate, planName=$planName, planActive=$planActive]';
