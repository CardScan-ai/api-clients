...
class EligibilityApiResponse {
  ...
  EligibilityApiResponse({
    ...
    this.eligibilitySummarizedResponse = const {},
    this.error,
  ...
  Map<String, Object>? eligibilitySummarizedResponse;

  EligibilityApiResponseError? error;
  ...
  bool operator ==(Object other) => identical(this, other) || other is EligibilityApiResponse &&
    ...
    _deepEquality.equals(other.eligibilitySummarizedResponse, eligibilitySummarizedResponse) &&
    other.error == error &&
  ...
  @override
  String toString() => 'EligibilityApiResponse[eligibilityId=$eligibilityId, state=$state, cardId=$cardId, eligibilityRequest=$eligibilityRequest, eligibilityResponse=$eligibilityResponse, eligibilitySummarizedResponse=$eligibilitySummarizedResponse, error=$error, createdAt=$createdAt, updateAt=$updateAt]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.error != null) {
      ...
      json[r'update_at'] = this.updateAt.toUtc().toIso8601String();
    return json;
  }
  ...
  static EligibilityApiResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EligibilityApiResponse(
        ...
        eligibilitySummarizedResponse: mapCastOfType<String, Object>(json, r'eligibility_summarized_response') ?? const {},
        error: EligibilityApiResponseError.fromJson(json[r'error']),
        createdAt: mapDateTime(json, r'created_at', r'')!,
        updateAt: mapDateTime(json, r'update_at', r'')!,
      );
    }
    return null;
  }
