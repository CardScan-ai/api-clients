...
class CardScanApi {
  ...
  ///
  /// * [Object] body:
  Future<Response> cardPerformanceWithHttpInfo(String cardId, { Object? body, }) async {
    // ignore: prefer_const_declarations
    final path = r'/cards/{card_id}/performance'
  ...
  ///
  /// * [Object] body:
  Future<CardPerformance200Response?> cardPerformance(String cardId, { Object? body, }) async {
    final response = await cardPerformanceWithHttpInfo(cardId,  body: body, );
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CardPerformance200Response',) as CardPerformance200Response;
  ...
  ///
  /// * [String] cursor:
  Future<Response> listEligibilityWithHttpInfo({ int? limit, String? cursor, }) async {
    // ignore: prefer_const_declarations
    final path = r'/eligibility';
  ...
  ///
  /// * [String] cursor:
  Future<ListEligibility200Response?> listEligibility({ int? limit, String? cursor, }) async {
    final response = await listEligibilityWithHttpInfo( limit: limit, cursor: cursor, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [Object] body:
  Future<Response> setScanMetadataWithHttpInfo(String scanId, { Object? body, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [Object] body:
  Future<void> setScanMetadata(String scanId, { Object? body, }) async {
    final response = await setScanMetadataWithHttpInfo(scanId,  body: body, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
