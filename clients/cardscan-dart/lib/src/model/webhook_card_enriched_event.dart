...
part 'webhook_card_enriched_event.g.dart';
...
@BuiltValue()
abstract class WebhookCardEnrichedEvent implements Built<WebhookCardEnrichedEvent, WebhookCardEnrichedEventBuilder> {
  ...
  WebhookCardEnrichedEvent._();

  factory WebhookCardEnrichedEvent([void updates(WebhookCardEnrichedEventBuilder b)]) = _$WebhookCardEnrichedEvent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WebhookCardEnrichedEventBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WebhookCardEnrichedEvent> get serializer => _$WebhookCardEnrichedEventSerializer();
}

class _$WebhookCardEnrichedEventSerializer implements PrimitiveSerializer<WebhookCardEnrichedEvent> {
  @override
  final Iterable<Type> types = const [WebhookCardEnrichedEvent, _$WebhookCardEnrichedEvent];

  @override
  final String wireName = r'WebhookCardEnrichedEvent';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WebhookCardEnrichedEvent object, {
  ...
  void _deserializeProperties(
    ...
    required WebhookCardEnrichedEventBuilder result,
  ...
  @override
  WebhookCardEnrichedEvent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WebhookCardEnrichedEventBuilder();
