...
part 'webhook_card_completed_event.g.dart';
...
abstract class WebhookCardCompletedEvent implements Built<WebhookCardCompletedEvent, WebhookCardCompletedEventBuilder> {
  ...
  WebhookCardCompletedEvent._();

  factory WebhookCardCompletedEvent([void updates(WebhookCardCompletedEventBuilder b)]) = _$WebhookCardCompletedEvent;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WebhookCardCompletedEventBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WebhookCardCompletedEvent> get serializer => _$WebhookCardCompletedEventSerializer();
}

class _$WebhookCardCompletedEventSerializer implements PrimitiveSerializer<WebhookCardCompletedEvent> {
  @override
  final Iterable<Type> types = const [WebhookCardCompletedEvent, _$WebhookCardCompletedEvent];

  @override
  final String wireName = r'WebhookCardCompletedEvent';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WebhookCardCompletedEvent object, {
  ...
  void _deserializeProperties(
    ...
    required WebhookCardCompletedEventBuilder result,
  ...
  @override
  WebhookCardCompletedEvent deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WebhookCardCompletedEventBuilder();
