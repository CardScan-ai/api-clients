...
export class CardScanApi extends BaseAPI {
  ...
  public async checkEligibility(cardId: string, eligibility: EligibilityInfo) {
     ...
     * @memberof CardScanApi
     */
    public directUpload(orientation: ScanOrientation, captureType: ScanCaptureType, cardId: string, stringAny?: string | any, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).directUpload(orientation, captureType, cardId, stringAny, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CardScanApi
     */
    public listEligibility(limit?: number, cursor?: string, options?: RawAxiosRequestConfig) {
        return CardScanApiFp(this.configuration).listEligibility(limit, cursor, options).then((request) => request(this.axios, this.basePath));
    }
