...
class RequestSubscriber(BaseModel):
    """
    Loop: 2100C, Notes: Subscriber Detail  # noqa: E501
    """
    birth_sequence_number: Optional[constr(strict=True, max_length=9, min_length=0)] = Field(None, alias="birthSequenceNumber", description="Loop: 2100C Segment: INS, Element: INS17, Notes: Birth Sequence Number - must be exactly 9 positive unsigned numeric characters.")
    case_number: Optional[constr(strict=True, max_length=50, min_length=0)] = Field(None, alias="caseNumber", description="Loop: 2100C Segment: REF, Element: REF02, Notes: REF01=3H Case Number")
    medicaid_recipient_identification_number: Optional[constr(strict=True, max_length=80, min_length=0)] = Field(None, alias="medicaidRecipientIdentificationNumber", description="Loop: 2110C Segment: REF, Element: REF02, Notes: REF01=NQ Medicaid Recipient Identification Number")
    spend_down_amount: Optional[constr(strict=True, max_length=18, min_length=0)] = Field(None, alias="spendDownAmount", description="Loop: 2110C Segment: ATM, Element: ATM02, Notes: ATM01=R Spend Down")
    spend_down_total_billed_amount: Optional[constr(strict=True, max_length=18, min_length=0)] = Field(None, alias="spendDownTotalBilledAmount", description="Loop: 2110C Segment: ATM, Element: ATM02, Notes: ATM01=PB Billed Amount")
    coverage_level_code: Optional[constr(strict=True, max_length=3, min_length=0)] = Field(None, alias="coverageLevelCode", description="Loop: 2110C Segment: EQ, Element: EQ03, Notes: Retired, Not Used")
    member_id: Optional[constr(strict=True, max_length=80, min_length=0)] = Field(None, alias="memberId", description="Loop: 2100C and 2100D, Segment: MN1, Element: NM109, Notes: NM108=MI, memberId 2-80 alphanumeric characters")
    ...
    provider_code: Optional[StrictStr] = Field(None, alias="providerCode", description="Loop: 2100C and 2100D, Segment: PRV, Element: PRV01, Notes: Allowed Values are: 'AD' Admitting, 'AT' Attending, 'BI' Billing, 'CO' Consulting, 'CV' Covering, 'H' Hospital, 'HH' Home Health Care, 'LA' Laboratory, 'OT' Other Physician, 'P1' Pharmacist, 'P2' Pharmacy, 'PC' Primary Care Physician, 'PE' Performing, 'R' Rural Health Clinic, 'RF' Referring, 'SK' Skilled Nursing Facility, 'SU' Supervising")
    ...
    def case_number_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @validator('medicaid_recipient_identification_number')
    def medicaid_recipient_identification_number_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestSubscriber:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestSubscriber:
        """Create an instance of RequestSubscriber from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestSubscriber.parse_obj(obj)

        _obj = RequestSubscriber.parse_obj({
            "birth_sequence_number": obj.get("birthSequenceNumber"),
            "case_number": obj.get("caseNumber"),
            "medicaid_recipient_identification_number": obj.get("medicaidRecipientIdentificationNumber"),
            "spend_down_amount": obj.get("spendDownAmount"),
            "spend_down_total_billed_amount": obj.get("spendDownTotalBilledAmount"),
