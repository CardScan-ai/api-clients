...
class HealthCheck(BaseModel):
    ...
    HealthCheck
    """
    status: Optional[StrictStr] = Field(None, description="Health Status")
    version: Optional[StrictStr] = Field(None, description="API version")
    additional_properties: Dict[str, Any] = {}
    __properties = ["status", "version"]
