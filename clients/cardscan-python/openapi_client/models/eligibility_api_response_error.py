...
class EligibilityApiResponseError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EligibilityApiResponseError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EligibilityApiResponseError:
        """Create an instance of EligibilityApiResponseError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EligibilityApiResponseError.parse_obj(obj)

        _obj = EligibilityApiResponseError.parse_obj({
            "type": obj.get("type"),
            "code": obj.get("code"),
