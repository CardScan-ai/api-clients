...
class WebhookCardErrorEvent(BaseModel):
    """
    Triggered when an error occurs during a card scan.  # noqa: E501
    """
    ...
    error: WebhookCardErrorEventError = Field(...)
    ...
    __properties = ["card_id", "created_at", "deleted", "error", "session_id", "type", "updated_at", "user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookCardErrorEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookCardErrorEvent:
        """Create an instance of WebhookCardErrorEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookCardErrorEvent.parse_obj(obj)

        _obj = WebhookCardErrorEvent.parse_obj({
            "card_id": obj.get("card_id"),
            "created_at": obj.get("created_at"),
            "deleted": obj.get("deleted"),
            "error": WebhookCardErrorEventError.from_dict(obj.get("error")) if obj.get("error") is not None else None,
