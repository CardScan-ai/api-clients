...
class WebhookEligibilityCreatedEvent(BaseModel):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookEligibilityCreatedEvent:
        """Create an instance of WebhookEligibilityCreatedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookEligibilityCreatedEvent.parse_obj(obj)

        _obj = WebhookEligibilityCreatedEvent.parse_obj({
