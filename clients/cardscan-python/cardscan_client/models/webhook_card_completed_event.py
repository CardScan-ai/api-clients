...
class WebhookCardCompletedEvent(BaseModel):
    """
    Triggered after a successful insurance card scan  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookCardCompletedEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookCardCompletedEvent:
        """Create an instance of WebhookCardCompletedEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookCardCompletedEvent.parse_obj(obj)

        _obj = WebhookCardCompletedEvent.parse_obj({
